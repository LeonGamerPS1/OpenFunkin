...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("OpenFunkin", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("OpenFunkin", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "OpenFunkin";
		app.meta["name"] = "OpenFunkin";
		app.meta["packageName"] = "com.sample.openfunkin";
