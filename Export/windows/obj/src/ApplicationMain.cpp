...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("OpenFunkin",bb,21,9d,b3),::ApplicationMain_obj::create_dyn());
...
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("OpenFunkin",bb,21,9d,b3));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("OpenFunkin",bb,21,9d,b3));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.sample.openfunkin",d2,1b,3b,05));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("OpenFunkin",bb,21,9d,b3))
