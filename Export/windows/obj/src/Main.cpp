...
HXLINE(  14)		::main::FlxG_obj::stage = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(  15)		this->addChild( ::main::game::FlxGame_obj::__alloc( HX_CTX , ::states::TitleState_obj::__alloc( HX_CTX ),null()));
HXLINE(  16)		this->addChild( ::openfl::display::FPS_obj::__alloc( HX_CTX ,10,10,0));
            	}
